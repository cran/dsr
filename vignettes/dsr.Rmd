...
## Pre-analysis
The `dsr()` and `dsrr()` functions expects **pre-aggregated** event counts and unit-times by
...
**Note:** For the standardized population / ref data, the unit-time variable name must named *pop*.  
